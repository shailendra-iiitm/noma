...
Experimental evaluation on a 500-user test scenario demonstrates that NOMA-GNN achieves 96.5\% of optimal Blossom throughput (70.74 Gbps vs 73.30 Gbps) while providing a 52.9× computational speedup (846 ms vs 44.7 s) with O(N log N) complexity compared to O(N³) optimization methods. The lightweight 166K parameter model (650 KB footprint) is suitable for edge base station deployment.
