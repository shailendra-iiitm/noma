...
\begin{itemize}
    ...
    \item \textbf{SIC Feasibility:} Successful interference cancellation requires sufficient channel gain disparity between paired users (typically $\geq$ 8 dB).
...
\begin{itemize}
    ...
    \item SIC threshold $\gamma_{th}$ (typically 8 dB)
...
\begin{itemize}
    ...
    \item Power allocation coefficients $\alpha_{ij} \in (0,1)$ for each pair (i,j)
