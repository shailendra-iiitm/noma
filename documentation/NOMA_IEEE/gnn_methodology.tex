...
\begin{itemize}
    ...
    \item \textbf{Edge Weight Correlation:} Predicted pairing scores show strong alignment with Blossom optimal pairs, indicating effective learning of pairing patterns
\end{itemize}

These visualizations provide insight into how the GNN learns to identify compatible user pairs based on channel characteristics.
