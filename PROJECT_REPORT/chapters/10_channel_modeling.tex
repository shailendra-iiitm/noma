...
For training the GNN, we generate 200 high-density scenarios:

\begin{enumerate}
    \item \textbf{Fixed Density:} $N = 500$ users per scenario to study dense deployments
...
Total dataset size: 100,000 user samples (200 scenarios × 500 users).
